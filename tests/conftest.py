...
_TEST_CACHE_PATH = _REPO_ROOT / ".pytest_oqe_cache.sqlite"
...
_set_if_unset("OQE_CACHE_PATH", str(_TEST_CACHE_PATH))
_set_if_unset("OQE_SQLITE_CACHE_PATH", str(_TEST_CACHE_PATH))
_set_if_unset("OQE_CACHE_SQLITE_PATH", str(_TEST_CACHE_PATH))

# Optional "disable cache" flags (harmless if unused by your code).
_set_if_unset("OQE_DISABLE_CACHE", "0")
_set_if_unset("OQE_CACHE_DISABLED", "0")
