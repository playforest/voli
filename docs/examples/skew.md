...
```bash
poetry run voli ask "Show NVDA IV skew for next Friday"
```

```text
================================================================================
 VOLI | TICKER: NVDA | CATEGORY: SKEW | OK
================================================================================
[ SUMMARY ]
...
```bash
poetry run voli ask "What's the skew slope across strikes for TSLA next week?"
```
