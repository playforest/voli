...
the three methods and yield events from the neutral `oqe.llm.types` set.
"""
...
def get_default_provider_name() -> str:
    ...
    Order: explicit OQE_LLM_PROVIDER env var > 'anthropic' if ANTHROPIC_API_KEY
    ...
    explicit = os.environ.get("OQE_LLM_PROVIDER")
    if explicit:
